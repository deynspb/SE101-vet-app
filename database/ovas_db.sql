...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2024 at 01:57 PM
...
INSERT INTO `users` (`id`, `firstname`, `middlename`, `lastname`, `username`, `email`, `CODE`, `password`, `avatar`, `last_login`, `type`, `status`, `date_added`, `date_updated`) VALUES
(1, 'Deana', NULL, 'Pe Benito', 'admin', 'deynspebenito@gmail.com', 0, 'e10adc3949ba59abbe56e057f20f883e', 'uploads/avatar-1.png?v=1639468007', NULL, 1, 1, '2021-01-20 14:02:37', '2024-02-23 18:45:13'),
(3, 'Claire', NULL, 'Blake', 'cblake', 'pebenitodeanaludo@gmail.com', 0, '32fca879dbedb3a329119c1a6544b52b', 'uploads/avatar-3.png?v=1639467985', NULL, 2, 1, '2021-12-14 15:46:25', '2024-02-23 19:29:25');
